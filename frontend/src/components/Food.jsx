...
export default function Food(props)
{
    ...
    return (
        ...
        <div className="food">
            ...
            <h2>{food.name} ( {food.calories} cal for {eatenQuantity}g)</h2>
            ...
            <div className="track-control">
                ...
                <input type="number" onChange={calculateMacros} className="inp" placeholder="Quantity in Grams"/>
